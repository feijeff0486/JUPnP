...
//        }
    ...
    void executeAction(AndroidUpnpService upnpService, Service switchPowerService) {
        ...
        ActionInvocation setTargetInvocation =
                new SetTargetActionInvocation(action);
        ...
        upnpService.getControlPoint().execute(
                new ActionCallback(setTargetInvocation) {
                    ...
                    public void success(ActionInvocation invocation) {
                        ...
                        Log.d(TAG, "ActionCallback::success Successfully called action!");
                    }
                    ...
                    public void failure(ActionInvocation invocation,
                                        ...
                                        String defaultMsg) {
                        Log.e(TAG, "ActionCallback::failure " + defaultMsg);
                    }
                }
        );
    ...
    static class SetTargetActionInvocation extends ActionInvocation {
        ...
        SetTargetActionInvocation(Action action) {
            super(action);
            try {
