...
//        return new UDA10ServiceDescriptorBinderSAXImpl();
        ...
        // 解决org.fourthline.cling.binding.xml.DescriptorBindingException:
        // Could not parse service descriptor: java.lang.RuntimeException:
        // org.xml.sax.SAXNotRecognizedException: http://apache.org/xml/features/disallow-doctype-decl
        return new AndroidUDA10ServiceDescriptorBinderSAXImpl();
    }
